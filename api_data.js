define({ "api": [
  ...
  },
  {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "initials",
            "description": "<p>Iniciais da empresa.</p>"
          }
        ]
      }
    },
    "success": {
      ...
      "examples": [
        {
          "title": "Success-Response",
          "content": " {\n    \"id\": \"5e415c8a7c66c3592cf5c6cd\",\n    \"name\": \"Teste\",\n    \"desc\": \"Teste Company\",\n    \"initials\": \"T\",\n    \"config\": \"5e415c8a7c66c3592cf5c6cc\",\n    \"createdAt\": \"2020-02-10T13:37:14.621Z\",\n    \"updatedAt\": \"2020-02-10T13:37:14.621Z\",\n    \"active\": true\n}",
          "type": "json"
        }
      ]
    },
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -X POST \\\n  https://driveranalytics.com.br/api/companies/ \\\n  -H 'authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..PUGy6lPKFz1Kt9Z_pcOOahtCUMjvwSYTIrZdYgGa3xE' \\\n  -H 'cache-control: no-cache' \\\n  -H 'content-type: application/json' \\\n  -d '{\n\t\"name\": \"Teste\"\t,\n\t\"desc\": \"Teste Company\",\n\t\"initials\": \"T\"\n}'",
        "type": "curl"
      }
    ],
    "error": {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "count",
            "description": "<p>Total amount of companies.</p>"
          },
          {
            "group": "Success 200",
            "type": "Object[]",
  ...
  },
  {
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "Success-Response",
          "content": "{\n    \"id\": \"5e415cd0764fa95b0d8439ac\",\n    \"name\": \"Teste\",\n    \"desc\": \"Teste Company\",\n    \"initials\": \"T\",\n    \"config\": \"5e415cd0764fa95b0d8439ab\",\n    \"createdAt\": \"2020-02-10T13:38:24.436Z\",\n    \"updatedAt\": \"2020-02-10T13:38:24.436Z\",\n    \"active\": true\n}",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "Success-Response",
          "content": "{\n    \"id\": \"5e415cd0764fa95b0d8439ac\",\n    \"name\": \"Teste\",\n    \"desc\": \"Teste Desc\",\n    \"initials\": \"T\",\n    \"config\": \"5e415cd0764fa95b0d8439ab\",\n    \"createdAt\": \"2020-02-10T13:38:24.436Z\",\n    \"updatedAt\": \"2020-02-10T14:46:59.608Z\",\n    \"active\": true\n}",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "receiveEmail",
            "description": "<p>Flag para ativar recebimento de email com alertas de Viagem.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "role",
            "description": "<p>Papel do usuário: 'admin', 'manager', 'user', 'device'.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "company",
            "description": "<p>Id da empresa do qual o usuário será cadastrado.</p>"
          }
        ]
      }
    },
    "success": {
      ...
      "examples": [
        {
          "title": "Success-Response",
          "content": "{\n  \"id\": \"5e41a2ae7399d6354048bd52\",\n  \"email\": \"teste@teste.com\",\n  \"name\": \"Teste\",\n  \"company\": {\n      \"id\": \"5e41a05a2d2c392c387f9c4b\"\n  },\n  \"role\": \"user\",\n  \"receiveEmail\": false\n}",
          "type": "json"
        }
      ]
    },
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -X POST \\\n  https://driveranalytics.com.br/api/users/ \\\n  -H 'authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..PUGy6lPKFz1Kt9Z_pcOOahtCUMjvwSYTIrZdYgGa3xE' \\\n  -H 'cache-control: no-cache' \\\n  -H 'content-type: application/json' \\\n  -d '{\n\t\"email\": \"teste@teste.com\",\n\t\"name\": \"Teste\",\n\t\"receiveEmail\": \"false\",\n\t\"role\": \"user\",\n\t\"password\": \"teste123\",\n\t\"company\": \"5e41a05a2d2c392c387f9c4b\"\n  }'",
        "type": "curl"
      }
    ],
    "error": {
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "401",
            "description": "<p>admin, manager access only.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "type": "get",
    "url": "/users/me",
    "title": "Retrieve logger user info",
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "count",
            "description": "<p>Total amount of Users.</p>"
          },
          {
            "group": "Success 200",
            "type": "Object[]",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -X PUT \\\nhttps://driveranalytics.com.br/api/users/5e41a2ae7399d6354048bd52 \\\n-H 'authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..PUGy6lPKFz1Kt9Z_pcOOahtCUMjvwSYTIrZdYgGa3xE' \\\n-H 'cache-control: no-cache' \\\n-H 'content-type: application/json' \\\n-d '{\n\t\"email\": \"testemod@teste.com\",\n\t\"name\": \"Teste Mod\",\n\t\"receiveEmail\": \"true\",\n\t\"role\": \"manager\",\n\t\"company\": \"5e41a05a2d2c392c387f9c4b\"\n}'",
        "type": "curl"
      }
    ],
    "error": {
